...
@section('sidebar')
    <li>
        <a href="javascript:void(0)" hx-get="{{ url('/admin/page/statistics') }}" hx-target=".content" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
    ...
    @if(in_array('user_read', $permissions, true))
        <li>
            <a href="javascript:void(0)" hx-get="{{ url('/admin/page/users') }}" hx-target=".content" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
